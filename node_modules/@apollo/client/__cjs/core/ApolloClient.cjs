...
const incremental_1 = require("@apollo/client/incremental");
...
const QueryManager_js_1 = require("./QueryManager.cjs");
...
class ApolloClient {
    ...
    subscribe(options) {
        ...
        const mapped = observable.pipe((0, rxjs_1.map)((result) => ({
            ...result,
...
if (environment_1.__DEV__) {
    ApolloClient.prototype.getMemoryInternals = internal_1.getApolloClientMemoryInternals;
}
//# sourceMappingURL=ApolloClient.cjs.map
