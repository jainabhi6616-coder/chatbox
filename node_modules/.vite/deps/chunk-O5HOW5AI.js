...
var ApolloCache = class {
  constructor() {
    ...
    __publicField(this, "fragmentWatches", new Trie(true));
    /**
     ...
     */
    __publicField(this, "onAfterBroadcast", (cb) => cb());
  ...
  watchFragment(options) {
    ...
    function toResult(results) {
      const result = results.reduce((memo, result2, idx) => {
        ...
        memo.complete && (memo.complete = result2.complete);
...
var defaultStreamFieldMergeFn = (existing, incoming, { streamFieldInfo, existingData }) => {
  ...
  const length = (streamFieldInfo == null ? void 0 : streamFieldInfo.isLastChunk) ? incoming.length : Math.max(previous.length, incoming.length);
...
var Policies = class {
  ...
  runMergeFunction(existing, incoming, { field, typename, merge, path }, context, storage) {
    ...
    const streamInfo = (_c = (_b = (_a2 = context.extensions) == null ? void 0 : _a2[streamInfoSymbol]) == null ? void 0 : _b.deref()) == null ? void 0 : _c.peekArray(path);
    if (streamInfo) {
...
function makeMergeFieldFunctionOptions(policies, objectOrReference, fieldSpec, context, storage, existingData) {
  ...
  if (extensions && streamInfoSymbol in extensions) {
    ...
    const streamFieldInfo = (_a2 = streamInfo == null ? void 0 : streamInfo.deref()) == null ? void 0 : _a2.peekArray(fieldSpec.path);
    if (streamFieldInfo) {
  ...
  processSelectionSet({
    ...
    this.flattenFields(
      ...
      if (value !== void 0) {
        ...
        } else if (hasDirectives(["stream"], field) && Array.isArray(incomingValue) && ((_a2 = context2.extensions) == null ? void 0 : _a2[streamInfoSymbol])) {
          childTree.info = {
            field,
            typename,
...
var ObservableQuery = class {
  constructor({ queryManager, options, transformedQuery = queryManager.transform(options.query) }) {
    ...
    __publicField(this, "variablesUnknown", false);
    /**
  ...
  refetch(variables) {
    ...
    if (__DEV__ && variables && hasOwnProperty.call(variables, "variables")) {
      ...
      if (!vars || !vars.some((v) => v.variable.name.value === "variables")) {
        __DEV__ && invariant.warn(81, variables, ((_a2 = queryDef.name) == null ? void 0 : _a2.value) || queryDef);
      }
    }
...
var QueryInfo = class {
  ...
  shouldWrite(result, variables) {
    ...
    ((_a2 = result.extensions) == null ? void 0 : _a2[streamInfoSymbol]) === ((_b = lastWrite.result.extensions) == null ? void 0 : _b[streamInfoSymbol]));
  }
  get hasNext() {
...
var QueryManager = class {
  ...
  getObservableFromLink(query, context, variables, fetchPolicy, extensions, deduplication = (context == null ? void 0 : context.queryDeduplication) ?? this.queryDeduplication) {
    let entry = {};
...
function removeStreamDetailsFromExtensions(original) {
  var _a2;
  if (((_a2 = original.extensions) == null ? void 0 : _a2[streamInfoSymbol]) == null) {
    return original;
  }
...
//# sourceMappingURL=chunk-O5HOW5AI.js.map
